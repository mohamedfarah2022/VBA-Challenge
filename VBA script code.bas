...
Dim WS As Worksheet
    ...
    WS.Activate
        ...
        ' Establish the final row of the worksheet to be used
        ...
        ' Add Objective headings within the worksheet
        ...
        '-------------------------------------------------------------------------------------------------------------------------------------------
        'Bonus objective script
        
        ' Set Greatest % Increase, % Decrease, and Total Volume from the bonus work
        
        'Establish which cells the headings enter
